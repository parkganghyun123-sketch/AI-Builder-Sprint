...
ENTITLEMENTS: tuple[Entitlement, ...] = (
    ...
    Entitlement(
        ...
        label="계약과 임금은 본인이",
        audience=Audience.MINOR,
        summary="친권자나 후견인은 계약을 대신 체결할 수 없고, 미성년자는 임금을 독자적으로 청구할 수 있습니다.",
        detail=(
            "친권자나 후견인은 미성년자를 대신해 근로계약을 체결할 수 없습니다. "
            "미성년자는 임금을 독자적으로 청구할 수 있습니다. 임금 지급 방법이나 "
            "계좌의 적정성은 이 조문만으로 결론 내리지 않습니다."
        ),
    ...
    Entitlement(
        ...
        audience=Audience.PREGNANT,
        summary=(
            "임신 12주 이내 또는 32주 이후에는 원칙적으로 하루 2시간 단축을 신청할 수 "
            "있고, 1일 소정근로시간이 8시간 미만이면 6시간이 되도록 단축합니다."
        ),
        detail=(
            "임신 후 12주 이내 또는 32주 이후인 여성 근로자는 1일 2시간의 "
            "근로시간 단축을 신청할 수 있고, 사용자는 이를 허용해야 합니다. "
            "다만 1일 소정근로시간이 8시간 미만이면 단축 후 1일 근로시간이 "
            "6시간이 되도록 하는 범위에서 신청할 수 있습니다. "
            "임금을 깎을 수 없습니다. "
    ...
    Entitlement(
        ...
        summary="생후 1년 미만 유아를 가진 여성 근로자는 청구하면 하루 두 번, 각 30분 이상의 유급 수유 시간을 받을 기준이 있습니다.",
        detail=(
    ...
    Entitlement(
        ...
        summary="직무 수행에 필요한 정당한 편의와 사업장 상황을 구체적으로 확인할 수 있습니다.",
        detail=(
            "사용자는 장애인이 장애가 없는 사람과 동등하게 근로할 수 있도록 "
            "정당한 편의를 제공해야 합니다. 필요한 편의의 종류, 담당 직무, 현재 시설과 "
            "업무 방식, 사업주와 협의한 내용을 확인해야 합니다. 구체적인 편의의 범위와 "
            "차별·위반 여부는 이 안내만으로 결론 내리지 않습니다."
        ),
